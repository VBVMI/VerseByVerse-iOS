...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ObjcExceptionBridging-tvOS/ObjcExceptionBridging.framework"
  ...
  install_framework "${PODS_ROOT}/Reveal-SDK/RevealServer-12/tvOS/RevealServer.framework"
