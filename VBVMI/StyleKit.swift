...
public class StyleKit : NSObject {
    ...
    public class func drawCanvas3(progress progress: CGFloat = 1) {
        //// Color Declarations
        let completionBlue = UIColor(red: 0.320, green: 0.527, blue: 0.800, alpha: 1.000)

        //// Variable Declarations
        let angle: CGFloat = -(progress * 360) + 90

        //// Oval Drawing
        let ovalRect = CGRect(x: 0, y: 0, width: 10, height: 10)
